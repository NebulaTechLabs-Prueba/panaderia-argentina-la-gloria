...
export const productosMock = [
  ...
  { id: "p-sandwich-mila", categoria_id: "cat-milanesas", nombre: "Sándwich de Milanesa", descripcion: "Milanesa de carne o pollo, mozzarella, jamón, lechuga, tomate y huevo frito.", precio_centavos: 1400, unidad: "uni", estimado: true, imagen_url: null, disponible: true, destacado: false, orden: 3, etiqueta: null },
  ...
  { id: "p-pan-frances", categoria_id: "cat-milanesas", nombre: "Pan Francés", descripcion: "Jamón crudo o cocido y queso.", precio_centavos: 600, unidad: "uni", estimado: true, imagen_url: null, disponible: true, destacado: false, orden: 5, etiqueta: null },
  { id: "p-sandwich-miga", categoria_id: "cat-milanesas", nombre: "Sándwich de Miga", descripcion: "Surtidos. Unidad $3.50, ½ docena $20, docena $35.", precio_centavos: 350, unidad: "uni", estimado: false, imagen_url: null, disponible: true, destacado: false, orden: 6, etiqueta: null },
  ...
  { id: "p-milhojas", categoria_id: "cat-pasteleria", nombre: "Milhojas / Chajá / Brazo Gitano", descripcion: "", precio_centavos: 1500, unidad: "uni", estimado: true, imagen_url: null, disponible: true, destacado: false, orden: 8, etiqueta: "Orden previa" },
  ...
  { id: "p-torta-cumple", categoria_id: "cat-pasteleria", nombre: "Torta de Cumpleaños", descripcion: "A pedido, según ocasión.", precio_centavos: 4500, unidad: "uni", estimado: true, imagen_url: null, disponible: true, destacado: false, orden: 11, etiqueta: "Orden previa" },
  ...
  { id: "p-pizza-fugazzeta", categoria_id: "cat-pizzas", nombre: "Fugazzeta", descripcion: "Masa casera, cebolla frita y topping a elección.", precio_centavos: 2699, unidad: "uni", estimado: true, imagen_url: null, disponible: true, destacado: false, orden: 3, etiqueta: null },
  ...
  { id: "p-matambre", categoria_id: "cat-guarniciones", nombre: "Matambre", descripcion: "Matambre casero, se vende por peso.", precio_centavos: 0, unidad: "variable", estimado: false, imagen_url: null, disponible: true, destacado: false, orden: 6, etiqueta: null },
];
